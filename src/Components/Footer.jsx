...
const Footer = () => {
  ...
  return (
    <footer className="bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-gray-700 py-8 mt-12">
      <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 text-center sm:text-left">
        
        {/* Brand or About */}
        <div>
          <h3 className="text-xl font-bold text-gray-300">Badhon Shahrier</h3>
        ...
        {/* Contact Info */}
        <div>
          <h4 className="text-lg font-semibold text-gray-300 mb-2">Contact</h4>
          <p className="text-gray-300">Email : <a href="https://mail.google.com/mail/u/1/#inbox?compose=new" target="blank" className="text-blue-600 hover:underline">badhonshahrier404@gmail.com</a></p>
          <p>Location: Dhaka, Bangladesh</p>
        </div>

        {/* Social Links */}
        <div>
          <h4 className="text-lg font-semibold text-gray-300 mb-2">Follow Me</h4>
