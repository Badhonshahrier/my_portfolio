        ...
        <div className="flex flex-wrap gap-4 justify-center mt-12">
          {project.liveLink && (
            <a
              ...
              className="btn btn-success px-6 py-3 text-white font-medium rounded-lg shadow-lg flex items-center gap-2"
            >
              <FaGlobe /> Live Site
            </a>
          )}
...
const Section = ({ title, icon, children }) => (
  <motion.div
    className="bg-white/10 backdrop-blur-md border border-white/20 rounded-xl p-6 mb-8 shadow-lg"
    data-aos="fade-up"
  >
